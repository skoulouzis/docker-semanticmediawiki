...
# RUN composer require 'phpunit/phpunit=3.7.*' --update-with-dependencies
...
# RUN service mysql start
# RUN mysql -e 'create database its_a_mw;'

ENTRYPOINT bash fuseki-server --update --mem /db &>/dev/null
